package dev.dankom.mechacraft.container;
...
import dev.dankom.mechacraft.type.FunctionalIntReferenceHolder;
...
public class CokeOvenContainer extends Container {
    ...
    public CokeOvenTileEntity tileEntity;
    private IWorldPosCallable canInteractWithCallable;
    public FunctionalIntReferenceHolder currentSmeltTime;

    // Server Constructor
    public CokeOvenContainer(final int windowID, final PlayerInventory playerInv,
                                   final CokeOvenTileEntity tile) {
        super(ContainerInit.COKE_OVEN.get(), windowID);
    ...
    // Client Constructor
    public CokeOvenContainer(final int windowID, final PlayerInventory playerInv, final PacketBuffer data) {
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(canInteractWithCallable, playerIn, BlockInit.COKE_OVEN.get());
    }
